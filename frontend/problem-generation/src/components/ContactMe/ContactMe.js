...
function ContactMe() {
  return (
    <div className="icon-container">
      ...
      <div className="icon">
        <a href="https://www.instagram.com/ben_wills123/?hl=en-gb" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faInstagram} className="contact-icon" /></a>
      </div>
      <div className="icon">
        <a href="https://twitter.com" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faTwitter} className="contact-icon" /></a>
      </div>
      <div className="icon">
